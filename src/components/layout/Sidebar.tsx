...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, onSelectTab }) => {
  ...
  const navItems: {
    ...
    { id: 'tenants', label: 'Tenants', icon: Users, permission: 'tenant.read', allowedRoles: ['SUPER_ADMIN', 'PROPERTY_MANAGER', 'ACCOUNTANT', 'RECEPTION'] },
    { id: 'contracts', label: 'Contracts & Leases', icon: FileText, permission: 'contract.read', allowedRoles: ['SUPER_ADMIN', 'PROPERTY_MANAGER', 'ACCOUNTANT', 'RECEPTION'] },
